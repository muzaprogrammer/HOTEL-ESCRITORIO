...
namespace CapaPresentacion
{
    public partial class FormEditarCliente : Form
    {
        ...
        private void enviardatos()
        {
            ...
            form.SetCliente(txtIdCliente.Text, txtNombres.Text, txtApellidos.Text, txtTDocumento.Text, txtNDocumento.Text, Convert.ToString(dtpFechaNacimiento.Value), Convert.ToString(comboxGenero.SelectedItem), txtTelefono.Text, txtPais.Text, txtEmail.Text);
        }
