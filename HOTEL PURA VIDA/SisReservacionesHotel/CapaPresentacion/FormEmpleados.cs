...
namespace CapaPresentacion
{
    public partial class FormEmpleados : Form
    {
        ...
        private void dataListado_DoubleClick(object sender, EventArgs e)
        {
            ...
            par1 = Convert.ToString(this.dataListado.CurrentRow.Cells["EMP_ID"].Value);
            par2 = Convert.ToString(this.dataListado.CurrentRow.Cells["EMP_NOMBRES"].Value);
            par3 = Convert.ToString(this.dataListado.CurrentRow.Cells["EMP_APELLIDOS"].Value);
            par4 = Convert.ToString(this.dataListado.CurrentRow.Cells["EMP_TURNO"].Value);

            form.SetEmpleado(par1, par2, par3, par4);
