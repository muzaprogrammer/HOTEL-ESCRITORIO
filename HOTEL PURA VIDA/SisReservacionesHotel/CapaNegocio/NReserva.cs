...
namespace CapaNegocio
{
    public class NReserva
    {
        ...
        {
            return new DReserva().MostrarReserva();
        }
        public static DataTable BuscarResClienteNombre(string textobuscar1, string textobuscar2)
        {
            DReserva Obj = new DReserva();
            Obj.TEXTO_BUSCAR1 = textobuscar1;
            Obj.TEXTO_BUSCAR2 = textobuscar2;
            return Obj.BuscarResNomCli(Obj);
        }
        public static DataTable BuscarResPaisCli(string textobuscar1, string textobuscar2)
        {
            DReserva Obj = new DReserva();
            Obj.TEXTO_BUSCAR1 = textobuscar1;
            Obj.TEXTO_BUSCAR2 = textobuscar2;
            return Obj.BuscarPaisCli(Obj);
        }
    }
}
