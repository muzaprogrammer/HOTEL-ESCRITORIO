...
namespace CapaDatos
{
    public class DReserva
    {
        ...
        public DataTable MostrarHabsNoDisponibleNum(DReserva Disponibilidad)
        {
            DataTable DtResultado = new DataTable("HABITACIONES, RESERVA, CLIENTES");
            SqlConnection SqlCon = new SqlConnection();
            try
            {
                ...
                SqlCommand SqlCmd = new SqlCommand();
                SqlCmd.Connection = SqlCon;
                SqlCmd.CommandText = "RES_HAB_NO_DISPONIBLE_NUM";
                SqlCmd.CommandType = CommandType.StoredProcedure;

                Convert.ToInt32(TEXTO_BUSCAR2);
                SqlParameter ParHabNum = new SqlParameter();
                ParHabNum.ParameterName = "@HAB_NUM";
                ParHabNum.SqlDbType = SqlDbType.Int;
                ParHabNum.Value = Disponibilidad.TEXTO_BUSCAR2;
                SqlCmd.Parameters.Add(ParHabNum);
        ...
        public DataTable Mostrarreserva()
        {
            ...
            try
            {
                ...
                SqlCommand SqlCmd = new SqlCommand();
                SqlCmd.Connection = SqlCon;
                SqlCmd.CommandText = "MOSTRAR_RESERVAS";
                SqlCmd.CommandType = CommandType.StoredProcedure;
